...
public class ListTestTest {
    ...
    public void letsMockListSizeWithMultipleReturnValues() {
        List list = mock(List.class);
        when(list.size()).thenReturn(10, 20); // Fix
    ...
    public void letsMockListGet() {
        ...
        // Does the next line pass or fail? Why? If it fails, how do we make it pass?
        // What is the value of list.get(1)?
        // The line passes. The value of list.get(1) is null.
